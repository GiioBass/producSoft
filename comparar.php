<?php
   ...
   $totalEuro = convertirEuro($valor2);

    function compararValores($a ,$b){

        if ($a > $b) {
            
            return 'El valor en pesos es mayor';
        }elseif ($a < $b) {
            
            return ' El valor en Euros es mayor';
...
echo '<div class="container  col-12 " style="height:350px" >';
   echo '<div class="mt-5 pt-5">';
        echo '<div class="d-flex justify-content-center ">';
           echo '<p class="display-4 font-weight-bold"> ' .compararValores($valor1, $totalEuro). '</p>';
        echo '</div>';
       echo '<div class="d-flex justify-content-center" >';
       echo '<a href="comparar.html" style="text-decoration: none">';
