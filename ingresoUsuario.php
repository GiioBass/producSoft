...
$contraseñaUsuario = @$_POST['contraseña-usuario'];
$estadoUsuario = @$_POST['estado-usuario'];
...
$ingresaDatos = "INSERT INTO usuarios (
            nombre_usuario, contraseña_usuario, estado_usuario )
        VALUES (
           ' $nombreUsuario', '$contraseñaUsuario', $estadoUsuario
        )
         ";
